module avkeyboard_tb;
  ...
  initial begin
    ...
    // The whole point of the command: KEYBOARD.v must see scan mode, or a title
    // that asks for make/break codes is told yes and keeps getting FM-7 codes.
    if (coding !== 2'd2) $fatal(1, "CODING out = %0d after set coding 2", coding);
